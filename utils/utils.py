...
def get_key_2d_data(name):
    '''
    name in format './content/test_2d_images/spleen_52_95.nii.gz'
    brute force keys for MSD tasks: ['10_3', '10_06', '10_07','10_08', '10_09', '10_10']
    '''
    img_name = name.strip().split('/')[-1]
    organ_name = img_name.split('_')[0].lower()

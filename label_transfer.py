...
from utils.utils import get_key, get_key_2d_data

ORGAN_DATASET_DIR = './'
ORGAN_LIST = 'dataset/MSD_2d.txt'
NUM_WORKER = 0
NUM_CLASS = 32
## full list
# TRANSFER_LIST = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10_03', '10_06', '10_07', '10_08', '10_09', '10_10', '12', '13', '14']
TRANSFER_LIST = ['10_03', '10_06', '10_07','10_08', '10_09', '10_10']
TEMPLATE={
...
def generate_label_2d_data(input_lbl, num_classes, name, TEMPLATE, raw_lbl):
    """
    Convert class index tensor to one hot encoding tensor with -1 (ignored).
    Args:
         input: A tensor of shape [bs, 1, *]
    ...
    for b in range(B):
        dataset_index = 10
        template_key = get_key_2d_data(name)
...
for line in open(ORGAN_LIST):
    key = get_key_2d_data(line.strip().split()[0]) 
...
for index, batch in enumerate(train_loader):
    ...
    y = generate_label_2d_data(y, NUM_CLASS, name, TEMPLATE, y_raw) # CHANGE THIS FUNCTIONS CONTENTS
    name = batch['name'][0].replace('label', 'post_label') # THIS MUST PROBABLY BE CHANGED FROM 'label' to 'mask'
    print(name)
